...
CREATE  INDEX  "front_page_location_locale_front_page_locale_id_index" ON "front_page_location_locale" ("front_page_locale_id");
...
CREATE  INDEX  "front_page_reference_tile_locale_language_id_index" ON "front_page_reference_tile_locale" ("language_id");
ALTER TABLE "front_page_reference_tile_locale"
  ADD "label" text;
ALTER TABLE "front_page_reference_tile_locale"
